package com.tzj.tzjcustomview.wheelviewtest;
...
//            views.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, displayItemCount));
...
//        int padding = dip2px(15);
//        tv.setPadding(padding, padding, padding, padding);
        LinearLayout ll = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.item_wheel, null, false);
        TextView tv1= (TextView) ll.findViewById(R.id.tv1);
        TextView tv2= (TextView) ll.findViewById(R.id.tv2);
        tv1.setText(item);
        tv2.setText(item);
        if (0 == itemHeight) {
            itemHeight = getViewMeasuredHeight(ll);
            Log.d(TAG, "itemHeight: " + itemHeight);
//            views.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, itemHeight * displayItemCount));
            views.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, displayItemCount));
            LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) this.getLayoutParams();
...
//                itemView.setTextColor(Color.parseColor("#f74646"));
                tv1.setTextColor(Color.parseColor("#f74646"));
                tv2.setTextColor(Color.parseColor("#f74646"));
            } else {
//                itemView.setTextColor(Color.parseColor("#bbbbbb"));
                tv1.setTextColor(Color.parseColor("#bbbbbb"));
